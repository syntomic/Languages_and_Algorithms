...
from Queue import PrioQueue, SQueue #pylint: disable=no-name-in-module

"""
    模拟负责过境车辆的海关检查站
    目标提供较好的服务，保证合理的车辆等待时间和合理的建设成本
"""
class Simulation:
    """实现模拟过程"""
    def __init__(self, duration):
        self._eventq = PrioQueue.PrioQueue()
        self._time = 0
